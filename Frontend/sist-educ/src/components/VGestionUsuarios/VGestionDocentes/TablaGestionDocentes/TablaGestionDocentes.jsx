...
function TablaGestionDocentes({ docentes, onDocenteDeleted, onDocenteUpdated }) {
    ...
    const handleUpdate = async (updatedData) => {
        try {
            const response = await DocenteService.AdminUpdateProfesor(selectedDocente.usuarioId, updatedData);
                    ...
                    <tbody>
                        {docentes.map((docente) => (
                            <tr key={docente.usuarioId}>
                                ...
                                <td>{docente.nivel}</td>
                                <td>
                                    <PrimaryButton onClick={() => handleEditClick(docente)} nombre="Editar" />
                                </td>
                                <td>
                                    <PrimaryButton onClick={() => handleDeleteClick(docente.usuarioId)} nombre="Eliminar" />
                                </td>
                            </tr>
                        ))}
                    </tbody>
